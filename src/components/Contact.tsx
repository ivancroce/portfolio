    ...
    <section className="py-5 bg-darker overflow-hidden" id="contact">
      <motion.div variants={containerVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.1 }} className="container pt-5">
        <div className="text-center mb-5">
          ...
          <motion.h2 variants={titleVariants} className="display-4 fw-bold text-white">
            Let's work together
          </motion.h2>
        ...
        <div className="row justify-content-center mb-5 g-4">
          <motion.div variants={linkedinCardVariants} className="col-md-4 col-lg-3">
            <a href="https://www.linkedin.com/in/ivancroce" target="_blank" rel="noopener noreferrer" className="text-decoration-none">
              <div className="card h-100 gradient-card p-4 hover-effect text-center group">
                <div className="mb-3 text-primary h3">
                  <FaLinkedin />
                </div>
          ...
          <motion.div variants={emailCardVariants} className="col-md-4 col-lg-3">
