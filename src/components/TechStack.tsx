...
const techs: Tech[] = [
  ...
  { name: "WordPress", img: "/logos/wordpress-logo.webp" },
  { name: "Canva", img: "/logos/canva-logo.webp" },
  { name: "Claude", img: "/logos/claude-logo.png" },
  { name: "Antigravity", img: "/logos/antigravity-logo.png" }
];
